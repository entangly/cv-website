    ...
    const employmentHistory = [
      {
        ...
        'description': "Jakt is a full stack product studio that offers design, development and business strategy services. \n\n Working in a small team as the lead backend developer, I delivered multiple successful applications across the finance, healthcare and social media industries. Primarily using Django/Python to produce scalable REST APIs for mobile apps and web applications, my team took start-ups’ ideas and transformed them into industry changing products. \n\n When working on full stack projects, I also collaborated on front end implementation and architecture using React, Redux and SCSS. With experience complying to both PCI and HIPAA regulations, I designed company-wide best practices documentation and templates, focusing on high security, code reusability and simplicity.",
      },
      {
      ...
      },
      {
        ...
        'list': ["Developed an award winning NearYouNow API to provide local and relevant news stories to national media outlets and a dashboard interface for journalists to manage content",
         "Delivered a distance learning application written in Django and Python",
         "Optimization of users adverts using custom build algorithms taking mathematical data from the Google Adwords API for the in-house ad agency."
        ]
      },
    ]

    const jobs = employmentHistory.map((jobDetails, index) => {
      return <Job key={index} title={jobDetails.title} description={jobDetails.description} open={index===0} list={jobDetails.list} />
    })
